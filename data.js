...
[
    ...
    {
        id: '2',
        title: 'What is multi-cloud? And why should developers care?',
        excerpt: 'Most developers do not care about multi-cloud. But they should...',
        body:
        'Most developers do not care about multi-cloud. But they should. Whether developers know it or not, their companies likely already have a multi-cloud environment.    Multi-cloud is a strategy where a business selects different services from different cloud providers',
    },
    {
        id: '3',
        title: 'Here is how to make your website more accessible',
        excerpt:
        'An accessible website is one that is optimized for all people, including those with disabilities...',
        body:
    ...
    },
    {
        ...
        body:
        'We can not get enough of our mobile apps. There were 204 billion apps downloads last year, and that number is rising in 2020.  When app stores entered the mainstream tech culture, they exposed developers to an audience of millions who were keen to adopt the innovative capabilities',
    },
]